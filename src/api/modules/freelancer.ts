...
const freelancerApi = {
  ...
  updateLanguage: async(id: string, params: object) => service.patch(`${BASE_PREFIX}/freelancer/update-language/${id}`, params),
  deleteLanguage: async(id: string) => service.patch(`${BASE_PREFIX}/freelancer/delete-language/${id}`),
