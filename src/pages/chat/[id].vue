...
<template>
  ...
  <div class="flex-1 mt-15 p:2 sm:p-6 justify-between flex flex-col h-screen">
    ...
    <div v-for="message in messages[0]" id="messages" :key="message._id" class="flex flex-col space-y-4 p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch">
      <div v-if="message.idSender === props.id" class="chat-message">
