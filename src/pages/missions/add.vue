  ...
  level: [
    {
      ...
      validator: async(_rule: RuleObject, value: string) => {
        if (!value || !levels.value.map(l => l.value).includes(value)) return Promise.reject(new Error('Veuillez saisir votre niveau'))
...
const validateBudget = async(_rule: RuleObject, value: any) => {
  ...
  if (!Number.isInteger(+formStateMission.budget))
    return Promise.reject(new Error('Veuillez saisir que des chiffres'))
}
const validatePeriodPrice = async(_rule: RuleObject, value: any) => {
  if (!formStateMission.price_per_day)
    return Promise.reject(new Error('Veuillez saisir le tarif du freelance'))
...
const validatePeriodMonth = async(_rule: RuleObject, value: any) => {
  ...
  if (!Number.isInteger(+formStateMission.period_per_month))
    return Promise.reject(new Error('Veuillez saisir que des chiffres'))
}
                    ...
                    <div class="p-4">
                      <div class="max-w-md mx-auto">
                        ...
                        >
                          ...
                          <a-form-item name="level" label="Choisir un niveau">
                            <a-select
                          ...
                          <a-form-item name="Coméptence" label="Séléctionner les compétences requises">
                            <a-select
                              v-model:value="skillsNeededValue"
                              mode="tags"
                              style="width: 100%"
                              :token-separators="[',']"
                          ...
                          <a-form-item name="Coméptence" label="Séléctionner les compétences appréciées ">
                            <a-select
                              v-model:value="skillsAppreciatedValue"
                              mode="tags"
                              style="width: 100%"
                              :token-separators="[',']"
                              placeholder="Séléctionner les compétences requises"
                      ...
                      <div class="max-w-md mx-auto">
                        ...
                        >
                          ...
                          <a-form-item
                            v-if="formStateMission.supp_month" name="number_month" label="veuillez saisir le nombre de mois de travail estimé"
                            :rules="[{ required: true, validator: validatePeriodMonth, trigger: 'change' }]"
                          >
                          ...
                          <a-form-item v-if="formStateMission.supp_month" name="work_frequence" label="Fréquence optimale de la mission / Semaine">
                            <a-slider
                          ...
                          <a-form-item
                            ...
                            :rules="[{ required: true, validator: validateBudget, trigger: 'change' }]"
                          >
                          ...
                          <a-form-item name="local_city" label="Les locaux de la mission sont situés à">
